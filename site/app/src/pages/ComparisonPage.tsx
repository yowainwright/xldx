...
import { FEATURES, LIBRARIES } from "@/components/Comparison/constants";
import type { FeatureSupport } from "@/components/Comparison/types";
...
export function ComparisonPage() {
  return (
    <div className="not-prose">
      <h1 className="text-3xl font-bold">Library Comparison</h1>
